...
public class JwtService {
    ...
    private static final String SECRET_KEY = "YOUR VERY_LONG_BASE64URL_ENCODED_SECRET_KEY_HERE";
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        claims.put("role", ((Users) userDetails).getRole().name());
        claims.put("userId", ((Users) userDetails).getId());
